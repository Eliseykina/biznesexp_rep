				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-3 col-sm-12">
							<div class="logo">
								<a href="index.html" title="Malias"><img src="<?= SITE_TEMPLATE_PATH?>/img/logo.png" alt="Malias"></a>
							</div>
						</div>
											...
											<div class="mini-cart-content">
												<div class="cart-img-details">
													<div class="cart-img-photo">
														<a href="#"><img src="<?= SITE_TEMPLATE_PATH?>/img/product/total-cart.jpg" alt="#"></a>
													</div>
												...
												<div class="cart-img-details">
													<div class="cart-img-photo">
														<a href="#"><img src="<?= SITE_TEMPLATE_PATH?>/img/product/total-cart2.jpg" alt="#"></a>
													</div>
													<div class="cart-img-content">
                                            ...
                                            <li class="arrow-plus">
                                                ...
                                                <div class="cat-left-drop-menu cat-left-drop-menu-photo-contain">
                                                    ...
                                                    <div class="cat-left-drop-menu-left cat-left-drop-menu-photo">
                                                        <a href="#"><img src="<?= SITE_TEMPLATE_PATH?>/img/megamenu/vmega_blog1.jpg" alt="Product"></a>
                                                    </div>
                                                </div>
                                                <!-- MEGA MENU END -->
                                            </li>
						...
						<div class="slider-area">
							<div class="bend niceties preview-1">
								<div id="ensign-nivoslider" class="slides">	
									<img src="<?= SITE_TEMPLATE_PATH?>/img/sliders/slider-1/bg1.jpg" alt="Malias" title="#slider-direction-1"/>
				 					<img src="<?= SITE_TEMPLATE_PATH?>/img/sliders/slider-1/bg2.jpg" alt="Malias" title="#slider-direction-2"/>
									<img src="<?= SITE_TEMPLATE_PATH?>/img/sliders/slider-1/bg3.jpg" alt="Malias" title="#slider-direction-3"/><!-- 
									<img src="<?= SITE_TEMPLATE_PATH?>/img/sliders/slider-1/bg4.jpg" alt="" title="#slider-direction-4"/>  -->     
								</div>
								<!-- direction 1 -->
